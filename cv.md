...
### Education 
Initially, there were courses by Mikhail Rusakov, but mainly self-education, searching for information from various sources, analyzing master classes, copying other people's sites, etc.
